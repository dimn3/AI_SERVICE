...
AI_SSH_CONFIG = {
    'HOST': os.getenv('AI_SSH_HOST', ''),
    'PORT': int(os.getenv('AI_SSH_PORT', '22')),
    'USERNAME': os.getenv('AI_SSH_USERNAME', ''),
    'PASSWORD': os.getenv('AI_SSH_PASSWORD', ''),
}
...
# Для разработки - можно отключить CSRF проверку
